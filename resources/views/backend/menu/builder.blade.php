@extends ('backend.layouts.master-menu')

@section ('title', trans('menus.menus_management'))

@section('page-header')
    <h1>
        {{ trans('menus.menus_management') }}
...
@endsection
    ...
    <div class="col-md-8">  
      <div class="well">
        ...
        <div class="dd" id="nestable">
            <li class='dd-item nested-list-item' data-order='1' data-id='1'>
                <div class='dd-handle nested-list-handle'>
                <span class='glyphicon glyphicon-move'></span>
                                                         </div>
                                                           <div class='nested-list-content'>Menu 1
                <div class='pull-right'>
                <a href="#">Edit</a> |
                          <a href='#' class='delete_toggle' rel='1'>Delete</a>
                </div>
                </div>
            </li>
 ...
 <li class='dd-item nested-list-item' data-order='2' data-id=2'>
    ...
    <span class='glyphicon glyphicon-move'></span>
                                               ...
                                               <div class='nested-list-content'>Menu 2
                <div class='pull-right'>
    <a href="#">Edit</a> |
                          <a href='#' class='delete_toggle' rel='2'>Delete</a>
                                                                                                     </div>
                                                                                                       </div></li>
        </div>
   ...
   <div class="modal fade" id="newModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
     <div class="modal-dialog">
       <div class="modal-content">
        {!! Form::open(array('url'=>'backend/menu/new','class'=>'form-horizontal','role'=>'form')) !!}
  ...
  <!-- Delete item Modal -->
   <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
     <div class="modal-dialog">
       <div class="modal-content">
          {!! Form::open(array('url'=>'backend/menu/delete')) !!}
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            <h4 class="modal-title">Provide details of the new menu item</h4>
          </div>
