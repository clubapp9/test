...
@section('content')
    ...
    <h1>Transfer Existing Inventory</h1>
    <hr/>

    <div class="section" style="background-color:#fff; padding:2em;">

        {!! Form::open(['url' => 'admin/wine/inventory/transfer_inventory', 'class' => 'form-inline click-animations']) !!}
        ...
        <div class="input-group col-lg-8 col-xs-8 col-md-8">
            {!! Form::label('quantity', 'Quantity Transferring: ', ['for' => 'quantity', 'class' => 'control-label']) !!}
            <div style="clear: both;"></div>
        ...
        <div class="input-group col-lg-8 col-xs-8 col-md-8" style="padding-top:2em;">
            {!! Form::label('location_from_id', 'Location From: ', ['for' => 'name', 'class' => 'control-label']) !!}
            <div style="clear: both;"></div>
            <select id="add_location_select" class="form-control" name="location_from_id">
            ...
            {!! $errors->first('location_from_id', '<p class="help-block">:message</p>') !!}
        </div>
        ...
        <div class="input-group col-lg-8 col-xs-8 col-md-8" style="padding-top:2em;">
            {!! Form::label('location_to_id', 'Location To: ', ['for' => 'name', 'class' => 'control-label']) !!}
            <div style="clear: both;"></div>
            <select id="add_location_select" class="form-control" name="location_to_id">
                @if($inventory_locations)
                    @foreach ($inventory_locations as $inventory_location)
                        <option value="{{ $inventory_location->id }}">{{ $inventory_location->location }}</option>
                    @endforeach
            ...
            {!! $errors->first('location_to_id', '<p class="help-block">:message</p>') !!}
        </div>
        ...
        <div class="input-group col-lg-5 col-xs-5 col-md-5" style="padding-top:2em;">
            <input class="btn btn-primary form-control" type="submit" value="TRANSFER INVENTORY" style="margin:0;padding:0;font-size: 24px;">
        </div>
