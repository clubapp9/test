...
@section('content')
    ...
    <h1>Remove Existing Inventory</h1>
    <hr/>

    <div class="section" style="background-color:#fff; padding:2em;">

        {!! Form::open(['url' => 'admin/wine/inventory/remove_inventory', 'class' => 'form-inline click-animations']) !!}
        ...
        <div class="input-group col-lg-8 col-xs-8 col-md-8">
            {!! Form::label('quantity', 'Quantity Removing: ', ['for' => 'quantity', 'class' => 'control-label']) !!}
            <div style="clear: both;"></div>
        ...
        <div class="input-group col-lg-8 col-xs-8 col-md-8" style="padding-top:2em;">
            {!! Form::label('location_id', 'Location From: ', ['for' => 'name', 'class' => 'control-label']) !!}
            <div style="clear: both;"></div>
        ...
        <div class="input-group col-lg-5 col-xs-5 col-md-5" style="padding-top:2em;">
            <input class="btn btn-primary form-control" type="submit" value="REMOVE INVENTORY" style="margin:0;padding:0;font-size: 24px;">
        </div>
        <!--<div class="input-group col-lg-offset-1 col-lg-2 col-xs-2 col-md-2" style="padding-top:2em;">
