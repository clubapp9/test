...
@section('content')
    ...
    <h1>Create New Portfolio Debtor Entry</h1>
    <hr/>

    {!! Form::open(['url' => 'admin/portfolio', 'class' => 'form-horizontal']) !!}
            ...
            <div class="form-group {{ $errors->has('account_open_date') ? 'has-error' : ''}}">
                ...
                <div class="col-sm-6">
                    {!! Form::input('datetime-local', 'account_open_date', null, ['class' => 'form-control', 'required' => 'required']) !!}
            ...
            <div class="form-group {{ $errors->has('first_delinquent_date') ? 'has-error' : ''}}">
                ...
                <div class="col-sm-6">
                    {!! Form::input('datetime-local', 'first_delinquent_date', null, ['class' => 'form-control', 'required' => 'required']) !!}
            ...
            <div class="form-group {{ $errors->has('charge_off_date') ? 'has-error' : ''}}">
                ...
                <div class="col-sm-6">
                    {!! Form::input('datetime-local', 'charge_off_date', null, ['class' => 'form-control', 'required' => 'required']) !!}
            ...
            <div class="form-group {{ $errors->has('last_payment_date') ? 'has-error' : ''}}">
                ...
                <div class="col-sm-6">
                    {!! Form::input('datetime-local', 'last_payment_date', null, ['class' => 'form-control', 'required' => 'required']) !!}
            ...
            <div class="form-group {{ $errors->has('last_contact_date') ? 'has-error' : ''}}">
                ...
                <div class="col-sm-6">
                    {!! Form::input('datetime-local', 'last_contact_date', null, ['class' => 'form-control', 'required' => 'required']) !!}
