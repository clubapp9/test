    ...
    {!! Form::open(['route' => 'admin.access.users.store', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post']) !!}
        ...
        <div class="box box-success">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                   <!-- {!! Form::label('Collector Initials ID', trans('Collector Initials ID'), ['class' => 'col-lg-2 control-label']) !!}
                    <div class="col-lg-10">
                        {!! Form::text('collector_id', null, ['class' => 'form-control', 'placeholder' => 'CEC' ]) !!}
                    </div>-->
                </div><!--form control-->
