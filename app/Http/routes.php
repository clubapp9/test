 ...
 */
    ...
    $router->group(['namespace' => 'Backend'], function () use ($router) {
        $router->group(['prefix' => 'admin', 'middleware' => 'auth'], function () use ($router) {
            ...
            Route::post('assign_value_attributes', 'AJAXController@assign_value_attributes');

            Route::post('attach_dates', 'AJAXController@attach_dates');
            Route::post('rename_sheet', 'AJAXController@rename_sheet');
            Route::post('add_wine_type', 'AJAXController@add_wine_type');
            Route::post('add_location', 'AJAXController@add_location');
            Route::post('search_inventory', 'AJAXController@search_inventory');
            /**
            ...
            $router->group(['middleware' => 'access.routeNeedsPermission:view-backend'], function () use ($router) {
                ...
                require(__DIR__ . '/Routes/Backend/Wines.php');
...
Route::resource('winetypes--fields=wine_type:string', 'WineTypes--fields=wine_type:stringController');
Route::resource('winetypes', 'WineTypesController');
Route::resource('wine_locations', 'Wine_LocationsController');
Route::resource('wine_inventory', 'Wine_InventoryController');
Route::resource('revision_type', 'Revision_TypeController');
